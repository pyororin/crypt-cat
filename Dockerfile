...
ARG _IS_ORDER_RETRY
ARG _RETRY_DELAY
ENV IS_ACTUALLY_SELL_BUY=${_IS_ACTUALLY_SELL_BUY} SELL_BUY_AMOUNT=${_SELL_BUY_AMOUNT} SELL_BUY_PRICE=${_SELL_BUY_PRICE} IS_ORDER_RETRY=${_IS_ORDER_RETRY} RETRY_DELAY=${_RETRY_DELAY}
